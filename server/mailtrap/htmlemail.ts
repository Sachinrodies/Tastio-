            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to Tastio!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Tastio. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Tastio Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2025 Tastio. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Tastio Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2025 Tastio. All rights reserved.</p>
            </div>
